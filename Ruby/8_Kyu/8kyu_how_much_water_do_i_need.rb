...
# HOW MUCH WATER DO I NEED (8 kyu)
...
# Solution
def how_much_water(w, ml, c)
  c < ml ? "Not enough clothes" : c > ml*2 ? "Too much clothes" : ((c - ml).times { w += (w / 10.0) }; w.round(2) )
end


# codewars_id: 575fa9afee048b293e000287   |   07/01/2021 - 01:28:18
