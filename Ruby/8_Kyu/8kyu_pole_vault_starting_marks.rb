...
# POLE VAULT STARTING MARKS (8 kyu)
...
def starting_mark(height)
  ((10.67 - 9.45) / (1.83 - 1.52) * height + 10.67 - (10.67 - 9.45) / (1.83 - 1.52) * 1.83).round(2) * 100 / 100
end


# codewars_id: 5786f8404c4709148f0006bf   |   21/11/2020 - 13:40:51
