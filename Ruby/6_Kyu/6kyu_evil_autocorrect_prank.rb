...
def autocorrect(input)
  input.split.map { |e| e.match?(/^[^A-Za-z]?(you+|u)[^A-Za-z]?$/i) ? e.gsub(/you+|u/i, 'your sister') : e }.join(' ')
end


# codewars_id: 538ae2eb7a4ba8c99b000439   |   23/08/2021 - 01:06:02
