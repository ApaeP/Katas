...
# Solution
S={'AZ'=>'Arizona','CA'=>'California','ID'=>'Idaho','IN'=>'Indiana','MA'=>'Massachusetts','OK'=>'Oklahoma','PA'=>'Pennsylvania','VA'=>'Virginia'}
def bystate(str)
  str.split("\n").group_by{|e|e[-2..-1]}.sort_by(&:first).map{|a,b|[S[a],b.map{|x|x.gsub(/#{a}|\,/,a=>S[a],','=>'').prepend("..... ") }.sort].join("\r\n")}.join("\r\n ")
end


# codewars_id: 59d0ee709f0cbcf65400003b   |   26/07/2021 - 00:19:59
