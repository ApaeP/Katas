...
# REMOVE A SPECIFIC ELEMENT OF AN ARRAY (6 kyu)
...
def select_subarray(arr)
  arr.map.with_index do |e, i| 
    x = arr - [e]
    val = x.sum == 0 ? nil : (x.reduce(:*)/x.sum.to_f).abs
    [val, i, e]
  end.reject { |d| d[0].nil? }.min_by { |e| next if e[0].nil? ; e[0] }[1..2]
end


# codewars_id: 581bb3c1c221fb8e790001ef   |   04/12/2020 - 15:33:00
