...
# Solution
TRK = { 0 => "sıfır", 1 => "bir", 2 => "iki", 3 => "üç", 4 => "dört", 5 => "beş", 6 => "altı", 7 => "yedi", 8 => "sekiz", 9 => "dokuz", 10 => "on", 20 => "yirmi", 30 => "otuz", 40 => "kırk", 50 => "elli", 60 => "altmış", 70 => "yetmiş", 80 => "seksen", 90 => "doksan" }
def turkish_number(n)
  n > 9 ? "#{TRK[n.digits.last * 10]}#{" " + TRK[n.digits.first] unless n % 10 == 0}" : TRK[n]
end


# codewars_id: 5ebd53ea50d0680031190b96   |   17/12/2020 - 04:12:08
