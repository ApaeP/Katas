...
# CODING MEETUP 1  HIGHERORDER FUNCTIONS SERIES  COUNT THE NUMBER OF JAVASCRIPT DEVELOPERS COMING FROM EUROPE (7 kyu)
...
def count_developers(list)
  list.count { |e| e[:language] == 'JavaScript' && e[:continent] == 'Europe' }
end


# codewars_id: 582746fa14b3892727000c4f   |   24/04/2021 - 00:04:43
