...
def contentWeight(bottle_weight, scale) 
  x = bottle_weight.fdiv((factor = scale.split[0].to_i) + 1)
  scale.split[2] == "larger" ? x * factor : x
end


# codewars_id: 53921994d8f00b93df000bea   |   24/07/2021 - 21:47:58
