...
def balanced_num(n)
  y = n.digits
  return 'Balanced' if y.size.even? && y.size < 4
  x = y.size.odd? ? (y.size / 2) - 1 : (y.size / 2) - 2
  y[0..x].sum == y.reverse[0..x].sum ? 'Balanced' : 'Not Balanced'
end


# codewars_id: 5a4e3782880385ba68000018   |   09/12/2020 - 04:23:55
